...
type CharacterSet =
  | "classic-phonics"
  | "special-phonics"
  | "special-phonics-vowels"
  | "special-phonics-consonants";

type AlphabetProps = {
  set: CharacterSet;
};

const Entry: ModuleFederationEntry<AlphabetProps> = getModuleFederationEntry(
  ({ mountProps: { set } }) => {
    return (
      <AppContexts>
        ...
        {set === "special-phonics-consonants" && (
          <Alphabet.SpecialPhonicConsonants />
        )}
      </AppContexts>
    );
  }
