...
export default function RightSlash({ size = DEFAULT_LETTER_SIZE, color = DEFAULT_COLOR }: SvgProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M132 8L8 132" stroke={color} strokeWidth="3" strokeDasharray="8 4" />
    </svg>
  );
}
