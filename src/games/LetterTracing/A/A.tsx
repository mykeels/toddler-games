...
import { DEFAULT_LETTER_SIZE, DEFAULT_DOT_SIZE, DEFAULT_COLOR } from '../LetterTracing.consts';

export default function A({ size = DEFAULT_LETTER_SIZE, dotSize = DEFAULT_DOT_SIZE, color = DEFAULT_COLOR }: SvgProps) {
  return (
